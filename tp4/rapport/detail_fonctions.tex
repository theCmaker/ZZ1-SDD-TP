...
\subsection{liberer\_matrice}
  Cette fonction permet de libérér la mémoire occupée par la matrice. On fait une boucle for sur chaque élément de la table majeure et dans cette boucle on libère chaque listes avec la fonction \item{liberer\_liste} (permettant de libérer une liste chaînée).
