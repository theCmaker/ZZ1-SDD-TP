...
\begin{document}
  ...
  \chapter{Présentation}
    ...
    \section{Organisation du code source}
      Nous avons défini deux modules, le premier contient une fonction sous forme récurssive ansi que sa version sous forme itérative. Nous disposons également d'un module permettant de gérer une pile, qui est ainsi utilisée lors de la dérécurssification de la fonction.
      \input{code_source}
